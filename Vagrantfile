...
Vagrant.configure("2") do |config|
	...
	#    Vagrant VM just to remap ports.
                ...
                config.vm.network :forwarded_port, guest: 3947, host: 3947
                config.vm.network :forwarded_port, guest: 3948, host: 3948
                config.vm.network :forwarded_port, guest: 3949, host: 3949
